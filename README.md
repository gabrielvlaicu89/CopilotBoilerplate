...
3. Run the reusable prompt .github/prompts/create-initial-plan.prompt.md.
4. Run the reusable prompt .github/prompts/start-next-feature.prompt.md.
5. Repeat the start-next-feature prompt until all plan items are complete.
